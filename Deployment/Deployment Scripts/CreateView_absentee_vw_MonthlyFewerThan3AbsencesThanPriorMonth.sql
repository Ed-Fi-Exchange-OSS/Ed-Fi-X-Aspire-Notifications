/****** Object:  View [absentee].[vw_MonthlyFewerThan3AbsencesThanPriorMonth]    Script Date: 12/15/2020 5:27:15 PM ******/
SET ANSI_NULLS ON
GO
...
/****************************************************************************************************
NAME: [absentee].[vw_MonthlyFewerThan3AbsencesThanPriorMonth]

USE: Students with fewer than 3 absences than prior month

COMMENTS:
2020-03-05			DMa		original sproc created.
****************************************************************************************************/

CREATE VIEW [absentee].[vw_MonthlyFewerThan3AbsencesThanPriorMonth]
AS
	...
	WHERE 1=1
		...
		AND DaysAbsentPriorMonth < DaysAbsentPriorPriorMonth - 3
		AND sas.DaysAbsentPriorPriorMonth > 0
		AND scp.OptOut = 0
